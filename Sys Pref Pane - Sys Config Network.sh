...
# This checks to see if the authorizationdb right: system.services.systemconfiguration.network has been set to allow
# Reports:
# "Allow" if set
# "Not Set" if not set
...
db_right="system.services.systemconfiguration.network"
